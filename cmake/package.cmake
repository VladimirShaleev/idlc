find_program(SAMPLE_DPKG_BUILDPACKAGE_FOUND dpkg-buildpackage)
find_program(SAMPLE_RPMBUILD_FOUND rpmbuild)

include(CMakeDependentOption)
cmake_dependent_option(SAMPLE_BUILD_DEB_PACKAGE "Create DEB package" ON
    "SAMPLE_DPKG_BUILDPACKAGE_FOUND" OFF)
cmake_dependent_option(SAMPLE_BUILD_RPM_PACKAGE "Create RPM package" ON
    "SAMPLE_RPMBUILD_FOUND" OFF)
...
if(SAMPLE_BUILD_DEB_PACKAGE)
    list(APPEND CPACK_GENERATOR "DEB")
endif()

if(SAMPLE_BUILD_RPM_PACKAGE)
