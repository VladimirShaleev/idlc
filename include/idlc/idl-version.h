 ...
 * @details   Helper macro that stringizes version components (e.g., 1, 5, 4 -> "1.5.4")
 * @param[in] major Major version number
 * @param[in] minor Minor version number
 * @param[in] micro Micro version number
 ...
 * @details   Generates a string literal from version components (e.g., 1, 5, 4 -> "1.5.4")
 * @param[in] major Major version number
 * @param[in] minor Minor version number
 * @param[in] micro Micro version number
 * @return    Stringified version
 ...
 * @details Version string in "MAJOR.MINOR.MICRO" format (e.g., "1.5.4").
