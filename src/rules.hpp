...
//                 if (attr->as<ASTDocAttr>()->childs.empty()) {
//                     AttrName name(ctx);
//                     attr->accept(name);
...
//     HierarchyRules(Context& ctx, ASTNode* lastNode) noexcept : Visitor(ctx), lastNode(lastNode) {
//     }
//
//     void visit(ASTApi* node) override {
//         if (ctx.api() != nullptr) {
...
//     }
//
//     ASTDecl* findRoot() noexcept {
//         return findAnyParent<ASTApi, ASTImport>();
//     }
//
//     ASTNode* lastNode;
// };
